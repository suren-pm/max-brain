...
async def join_meeting(request: Request):
    ...
    # an outbound WebSocket to OUR /ws/{bot_id} endpoint and starts
    # streaming captured audio in. The bot_id is generated by max-bot.
    # Replaces the prior MBaaS path; MBaaS constants kept at module-top as
    # inactive fallback per Milestone E design spec section 9.
